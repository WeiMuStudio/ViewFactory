package com.luyinbros.viewlib.window;
...
/**
 * 在PopupWindow使用EditText的时候，无法实现长按复制粘贴功能，这个功能叫做selection markers。
 * <p>
 * 建议:
 ...
 */
public class EnhancePopupWindow {
    ...
    public EnhancePopupWindow(Context context) {
    ...
    private static class PopupWindowGlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
        private EnhancePopupWindow mPopupWindow;
        private boolean isOnlyGetWH = true;


        private PopupWindowGlobalLayoutListener(EnhancePopupWindow popupWindow) {
